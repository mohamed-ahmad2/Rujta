...
namespace Rujta.Infrastructure.Migrations
{
    ...
    [Migration("20260511001934_UpdatePayment")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rujta.Domain.Entities.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rujta.Domain.Entities.Discount", b =>
                {
                    ...
                    b.ToTable("Discounts", null, t =>
                        {
                            t.HasCheckConstraint("CK_Discounts_DateRange", "[EndDate] >= [StartDate]");
            ...
            modelBuilder.Entity("Rujta.Domain.Entities.Medicine", b =>
                {
                    ...
                    b.ToTable("Medicines", null, t =>
                        {
                            t.HasCheckConstraint("CK_Medicines_PositivePrice", "[Price] >= 0");
                        });
                });
            ...
            modelBuilder.Entity("Rujta.Domain.Entities.Payment", b =>
                {
                    ...
                    b.Property<string>("PendingOrderDtoJson")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Rujta.Domain.Entities.PricingConfig", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("AdBiweeklyPrice")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("AdMonthlyPrice")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("AdWeeklyPrice")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("SubscriptionYearlyPrice")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Rujta.Domain.Entities.Discount", b =>
                {
                    ...
                    b.HasOne("Rujta.Domain.Entities.Company", "Company")
                        .WithMany("Discounts")
